    ...
    <Card className="group h-full rounded-2xl border-2 border-gray-200 bg-white shadow-none transition-all duration-300 ease-in-out hover:border-blue-600">
      ...
      <CardContent className="h-full">
        <ChartContainer
          ...
          className="mx-auto h-[224px] max-w-[272px] md:h-[260px] md:max-w-[292px] lg:h-[340px] lg:max-w-[320px] xl:h-[348px] xl:max-w-[400px] 2xl:h-[420px] 2xl:max-w-[500px] [&_.recharts-text]:fill-background"
        >
          <BarChart
            accessibilityLayer
