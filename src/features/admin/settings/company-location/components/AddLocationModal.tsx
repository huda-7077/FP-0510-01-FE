...
const MapComponent = dynamic(() => import("@/components/Map"), {
  ssr: false,
  loading: () => (
    <div className="flex h-[300px] items-center justify-center rounded-lg bg-gray-100">Loading Map...</div>
  ),
})
...
export function AddLocationForm({ onSuccess }: AddLocationFormProps) {
  ...
  const { mutate: createLocation, isPending } = useCreateCompanyLocation()
    ...
    <form onSubmit={formik.handleSubmit} className="space-y-4">
      <div className="space-y-2">
        ...
        <Input
          ...
          className={formik.errors.address && formik.touched.address ? "border-red-500" : ""}
        />
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className={formik.errors.postalCode && formik.touched.postalCode ? "border-red-500" : ""}
        />
      ...
      <div className="space-y-2">
        ...
        <Input value={`${formik.values.latitude}, ${formik.values.longitude}`} readOnly className="bg-gray-50" />
      </div>

      <div className="flex justify-end gap-2">
        <Button type="submit" className="bg-[#0a65cc] hover:bg-[#254e7e]" disabled={isPending}>
