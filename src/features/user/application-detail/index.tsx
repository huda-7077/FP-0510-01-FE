      ...
      {isLoading ? (
        ...
        <>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      <div className="relative h-16 w-16 overflow-hidden rounded-md border">
                        <Image
                          src={application.job.company.logo || "/anonymous.svg"}
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        Rp {application.expectedSalary.toLocaleString("id-ID")}
                      </p>
                    </div>
                    <div>
                  ...
                  {application.status === "INTERVIEW_SCHEDULED" &&
                    application.interviews && (
                      <InterviewDetails interview={application.interviews[0]} />
                    )}
          ...
          <Card className="border-red-200 hover:bg-red-50">
            <CardHeader>
              <CardTitle className="text-red-600">Cancellation Zone</CardTitle>
              <CardDescription>
