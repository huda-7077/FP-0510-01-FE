...
const WorkExperienceForm = ({ onSuccess }: WorkExperienceFormProps) => {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="space-y-6">
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          {formik.touched.companyName && formik.errors.companyName && (
            <p className="text-xs text-red-500">{formik.errors.companyName}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={formik.errors.jobTitle && formik.touched.jobTitle ? "border-red-500" : ""}
          />
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-2">
          ...
          <Input
            ...
            className={formik.errors.startDate && formik.touched.startDate ? "border-red-500" : ""}
          />
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={formik.errors.endDate && formik.touched.endDate ? "border-red-500" : ""}
          />
      ...
      <div className="flex justify-end">
        <Button type="submit" className="w-xl bg-[#0a65cc] hover:bg-[#254e7e]" disabled={isPending || !formik.isValid}>
          {isPending ? (
            <>
